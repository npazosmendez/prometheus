...
// snappy decompression.
func DecodeMinimizedWriteRequest(r io.Reader, c *Compressor) (*prompb.MinimizedWriteRequest, error) {
	compressed, err := io.ReadAll(r)
	if err != nil {
		return nil, err
	}
...
func DecodeMinimizedWriteRequestLen(r io.Reader, c *Compressor) (*prompb.MinimizedWriteRequestLen, error) {
	compressed, err := io.ReadAll(r)
	if err != nil {
		return nil, err
	}
